...
def get_possible_crs(inputs_map, expected_values):
    INPUT_CRS_LIST = [
        ...
        ["Pulkovo 1942(58) / Poland zone I", "EPSG:3120", "Poland - southeast - south of 52°20'N and east of 18°E.",
         "1m"],
        ["ETRS89 / Poland CS2000 zone 7", "EPSG:2178", "Poland - onshore and offshore between 19°30'E and 22°30'E.",
         "1m"],
        ...
        ["Hartebeesthoek94 / ZAF BSU Albers 25E", "EPSG:9221", "South Africa - mainland - onshore and offshore.",
         "1 m"],
